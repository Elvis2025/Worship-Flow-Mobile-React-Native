...
function RootNavigator() {
  ...
  return (
    <Stack screenOptions={{ headerStyle: { backgroundColor: colors.background }, headerTintColor: colors.text, contentStyle: { backgroundColor: colors.background } }}>
      ...
      <Stack.Screen name="users/[id]" options={{ title: 'Detalle' }} />
      <Stack.Screen name="users/create" options={{ title: 'Crear usuario' }} />
      <Stack.Screen name="users/edit/[id]" options={{ title: 'Editar usuario' }} />
      <Stack.Screen name="users/availability/[id]" options={{ title: 'Disponibilidad' }} />
